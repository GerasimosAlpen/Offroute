...
const EMERGENCY_CONTACTS: EmergencyContact[] = [
  { name: "Pusat Komando", number: "112", icon: PhoneCall },
  { name: "Ambulans", number: "118", icon: PhoneCall },
  { name: "Pemadam Kebakaran", number: "113", icon: PhoneCall },
  { name: "SAR Nasional", number: "115", icon: PhoneCall },
];
...
export function FlareControl() {
  ...
  if (showContacts) {
    return (
      <div className="flex-1 h-full flex flex-col bg-[#131313]">
        <StatusHeader />
