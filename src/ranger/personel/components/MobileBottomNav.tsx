...
export function MobileBottomNav() {
  ...
  return (
    <nav className="w-full shrink-0 flex justify-around items-center px-4 pt-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] bg-[#131313] border-t-2 border-[#444] z-50">
      {TABS.map((tab) => {
